...
/* Interval within timer interrupt should be handled. Value in miliseconds. */
#define TL_TIMER_INT_MS	500
...
#ifdef QAT_ESXI
/* Device telemetry descriptor indices */
enum dev_tl_desc_ids {
	DEV_TL_DESC_ID_SAMPLE_CNT = 0,
	DEV_TL_DESC_ID_PCI_TRANS_CNT,
	DEV_TL_DESC_ID_MAX_RD_LAT,
	DEV_TL_DESC_ID_RD_LAT_ACC,
	DEV_TL_DESC_ID_MAX_LAT,
	DEV_TL_DESC_ID_LAT_ACC,
	DEV_TL_DESC_ID_BW_IN,
	DEV_TL_DESC_ID_BW_OUT,
	DEV_TL_DESC_ID_AT_PAGE_REQ_LAT_ACC,
	DEV_TL_DESC_ID_AT_TRANS_LAT_ACC,
	DEV_TL_DESC_ID_AT_MAX_TLB_USED,
	DEV_TL_DESC_ID_SLICE_UTIL_ATH,
	DEV_TL_DESC_ID_SLICE_UTIL_CPH =
		(DEV_TL_DESC_ID_SLICE_UTIL_ATH + HW_MAX_NUM_OF_SLICES),
	DEV_TL_DESC_ID_SLICE_UTIL_CPR =
		(DEV_TL_DESC_ID_SLICE_UTIL_CPH + HW_MAX_NUM_OF_SLICES),
	DEV_TL_DESC_ID_SLICE_UTIL_XLT =
		(DEV_TL_DESC_ID_SLICE_UTIL_CPR + HW_MAX_NUM_OF_SLICES),
	DEV_TL_DESC_ID_SLICE_UTIL_DCPR =
		(DEV_TL_DESC_ID_SLICE_UTIL_XLT + HW_MAX_NUM_OF_SLICES),
	DEV_TL_DESC_ID_SLICE_UTIL_PKE =
		(DEV_TL_DESC_ID_SLICE_UTIL_DCPR + HW_MAX_NUM_OF_SLICES),
	DEV_TL_DESC_ID_SLICE_UTIL_UCS =
		(DEV_TL_DESC_ID_SLICE_UTIL_PKE + HW_MAX_NUM_OF_SLICES),
	DEV_TL_DESC_ID_SLICE_UTIL_WAT =
		(DEV_TL_DESC_ID_SLICE_UTIL_UCS + HW_MAX_NUM_OF_SLICES),
	DEV_TL_DESC_ID_SLICE_UTIL_WCP =
		(DEV_TL_DESC_ID_SLICE_UTIL_WAT + HW_MAX_NUM_OF_SLICES),
	DEV_TL_DESC_ID_MAX =
		(DEV_TL_DESC_ID_SLICE_UTIL_WCP + HW_MAX_NUM_OF_SLICES),
};

/* RP telemetry descriptor indices */
enum rp_tl_desc_ids {
	RP_TL_DESC_ID_PCI_TRANS_CNT = 0,
	RP_TL_DESC_ID_LAT_ACC,
	RP_TL_DESC_ID_BW_IN,
	RP_TL_DESC_ID_BW_OUT,
	RP_TL_DESC_ID_GLOB_DEVTLB_HIT,
	RP_TL_DESC_ID_GLOB_DEVTLB_MISS,
	RP_TL_DESC_ID_PAYLD_DEVTLB_HIT,
	RP_TL_DESC_ID_PAYLD_DEVTLB_MISS,
	RP_TL_DESC_ID_MAX,
};
#endif /* QAT_ESXI */
